...
docker tag order-service docker.pkg.github.com/nexterid/a433-microservices/order-service:latest

# mengupload image ke docker hub/github package
docker push docker.pkg.github.com/nexterid/a433-microservices/order-service:latest
